...
cat /home/spacer/pwd | sudo -S su -c "supervisorctl reread sorting_visualizer_daphne"
cat /home/spacer/pwd | sudo -S su -c "supervisorctl reread sorting_visualizer_gunicorn"
